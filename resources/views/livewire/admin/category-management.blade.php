<x-layouts.app>
    <div class="space-y-6">
        ...
        <div class="overflow-x-auto bg-white dark:bg-zinc-900 rounded-lg shadow">
            <table class="w-full">
                ...
                <tbody class="divide-y divide-gray-200 dark:divide-zinc-700">
                    @php /** @var \Illuminate\Pagination\LengthAwarePaginator|\App\Models\Category[] $categories */ @endphp
        ...
        <!-- Modal (Flux) -->
        <flux:modal wire:model="showModal" name="category-modal" class="max-w-md">
