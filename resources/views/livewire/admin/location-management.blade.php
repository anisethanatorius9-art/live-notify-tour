<div class="space-y-6">
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-sm text-gray-600 dark:text-gray-400">Manage tourism locations</p>
        </div>
        ...
        <table class="w-full">
            ...
            <tbody class="divide-y divide-gray-200 dark:divide-zinc-700">
                ...
                <tr class="hover:bg-gray-50 dark:hover:bg-zinc-800">
                    ...
                    <td class="px-6 py-4 text-sm text-gray-600 dark:text-gray-400">{{ Str::limit($location->description, 50) }}</td>
